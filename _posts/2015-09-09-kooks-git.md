...
Toutefois, il faut encore penser d'avoir lancé cette commande, surtout lorsque l'on récupère du code depuis le répo central où le composer.lock peux avoir évolué.
...
Toutefois, ce dernier est relativemet lent, surtout sur les projets composés d'un grand nombre de fichiers.
