...
* Branch ![allthethings](/tech.bedrockstreaming.com/public/images/posts/reactnative/allthethings.png) : every bugfix or feature is developed on a new git branch,
* Pull Request (PR) ![allthethings](/tech.bedrockstreaming.com/public/images/posts/reactnative/allthethings.png) : we make PR for each bugfix or feature to propose the modification to the « master » git branch,
* Code Review ![allthethings](/tech.bedrockstreaming.com/public/images/posts/reactnative/allthethings.png) : other teammates have to review each PR and add :+1: when they agree with the modification,
* Test ![allthethings](/tech.bedrockstreaming.com/public/images/posts/reactnative/allthethings.png) : a CI system ([Jenkins](https://jenkins.io/)) runs Unit and Integration tests, and Lint on each PR,
* Preview ![allthethings](/tech.bedrockstreaming.com/public/images/posts/reactnative/allthethings.png) : an internal tool (Github Hooker) is called with a Github webhook on each PR to create a staging environment.
...
![Appetize](/tech.bedrockstreaming.com/public/images/posts/reactnative/appetize.png)
...
![Github Pull Request with preview url](/tech.bedrockstreaming.com/public/images/posts/reactnative/githubpr.png)
