...
author:
  name: Nastasia Saby (Zenika consultant)
  avatar:
  email:
...
To value our data in order to understand better our service and improve it, we use [Spark](https://spark.apache.org/). You can find more information in a [recent article about our datalake](http://tech.m6web.fr/data/genesis-of-m6-datalake/). We recently migrated our biggest project from Spark 1.5 to Spark 2.2 and wanted to share that story.
