...
E2E tests are also complex to setup, write and debug but are **absolutely necessary**. For the back office app, unlike our front app where [we use a custom stack](https://tech.bedrockstreaming.com/2016/01/25/tests-fonctionnels-app-js), we choose [Cypress](https://www.cypress.io/) a complete E2E framework that has saved us a lot of time.
...
[Kenny already talked about it in 2015](https://tech.bedrockstreaming.com/2015/04/01/immutablejs-relay-graphql-react-native) but now we use it!
