...
![Some loadtesting on our platform, which you may see as no traffic, huge traffic, then no traffic again](/images/posts/2021-10-18-increase-performance-and-stability-by-adding-an-egress-controller/error-port-allocation.png)
...
PHP application call another API on internet through the NAT gateway.
...
All outgoing requests now go through the Egress Controller, which pools and maintains TCP and TLS connections.
