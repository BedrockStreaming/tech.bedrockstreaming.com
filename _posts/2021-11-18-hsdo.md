...
Consistent Hashing is a very interesting hashing method for caching purposes.

![Consistent Hashing method](/images/posts/2021-11-18-hsdo/image9.png)
<center><ins>Consistent Hashing method</ins></center>

This hashing method allows to distribute the load so that all requests for the same object will always go to the same cache server. This way, each cache server has to store half of the objects.
