...
HSDO clients are consuming the DynamoDB table to get the cache servers. The clients run on the same instances as HAProxy and use the runtime API to update HAProxy config.
