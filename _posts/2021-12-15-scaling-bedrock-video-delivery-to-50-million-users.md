...
<center><ins>Details on the composition of a USP origin</ins></center>
...
<center><ins>Inefficiency of a Round Robin algorithm in front of cache servers</ins></center>
...
<center><ins>Consistent Hashing is an ideal method for caches</ins></center>
...
<center><ins>Nginx cache hit ratio</ins></center>
...
<center><ins>AWS Cost Explorer Octobre 2020</ins></center>
...
<center><ins>The costs of this platform, where v3 was deployed in mid-November 2020</ins></center>
...
<center><ins>v3 of our VOD platform</ins></center>
...
<center><ins>A server whose bandwidth is throttled (seen from CloudWatch)</ins></center>
...
defaults
   ...
   retries     2
   # We do not use "all-retryable-errors" because we don't want to retry on 500, which is an USP expected error code when it goes wrongly
...
<center><ins>Graph showing few overloaded servers, using classic consistent hashing</ins></center>
...
<center><ins>Graph showing the effects of Bounded Loads over Consistent Hashing</ins></center>
