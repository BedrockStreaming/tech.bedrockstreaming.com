...
Notre équipe technique était accompagnée par des membres de l’équipe RH qui a participé à la présentation de
l’entreprise. Nous avons pu, tous ensemble, vous accueillir sur le stand pour répondre aux questions sur notre activité,
notre organisation, la vie dans l’entreprise.

De leurs propres mots :

>“Notre présence au forum fût une réussite collective, qui nous a permis de nous faire connaître et mettre en lumière BEDROCK en tant que structure à part entière, et non plus en tant que « M6 Web ».
...
Durant ces deux journées, le stand Bedrock fût un point de rendez-vous agréable pour nos équipes et pour les autres participants curieux d’apprendre à nous connaître.
...
Les équipes Backend & RH étaient fiers de représenter Bedrock en participant à la vie du stand et de répondre aux questions des passants.

![Nos 2 Backend managers, Mikael et FX en train d’animer l’épreuve des casse-tête](/images/posts/forumphp2022/backend-managers.jpg)
...
les épaules de *Nikita Popov* et *Dmitry Stogov*. Lesquels faisaient cela de manière non-professionnel, comme un hobby,
...
- Calendrier d’onboarding clair avec installation de la machine, présentation de l’équipe rejoint par la nouvelle personne, des locaux, des projets…
- Système de marrainage/parrainage,
- Des formations disponibles sur les différentes technologies utilisées
- La Bedrock Academy pour avoir une vision globale des métiers au sein de notre entreprise.
- Un rapport d’étonnement qui nous permet d’avoir un retour du nouvel arrivant qui nous permet d’améliorer notre onboarding en continu
...
n’importe quel service et ceux qu’importe le langage.
...
- Receiver - Gère la récupération des données dans le collecteur. Il fonctionne sur une mécanique de push/pull et supporte nativement les protocoles HTTP et gRPC
- Processor - Permet le traitement des données avant l’envoi aux différents outils de monitoring
- Exporter - Envoie les donnés aux outils de monitoring. Il fonctionne également sur une mécanique push/pull.

Concernant l’utilisation du standard OpenTelemetry en PHP, il existe aujourd’hui un SDK cependant ce dernier ne possède
...
formules, il nous d’abord rappelé les différents types existant et futur (PHP 8.1 et 8.2) et comment ils sont
...
navigateurs à s’assurer que le contenu de la page respecte les règles de sécurités définies grâce à de nombreuses directives.
...
que [Google fourni un service en ligne](https://csp-evaluator.withgoogle.com) pour inspecter et valider les CSP de vos
pages web.
...
Cette année, c'est pas moins de 4 présentations qui étaient données par des personnes de chez Bedrock.
