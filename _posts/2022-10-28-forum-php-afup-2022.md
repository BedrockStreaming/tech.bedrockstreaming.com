...
- un rapport d’étonnement qui nous permet d’avoir un retour du nouvel arrivant et d’améliorer notre onboarding en continu
...
- Exporter - Envoie les donnés (via push ou pull) aux outils de monitoring.
