...
Tout ça par équipe de 5 personnes et avec des Lego :heart_eyes:.
Chaque personne avait un rôle particulier qui représente les différents rôles d'une équipe de développement standard.

L'objectif était de construire le plus de modèles d'un calendrier de l'avent Lego, donc des modèles petits et (en général) assez simples, nous avions 6 minutes par type d'organisation.Les rôles sont les suivants :
 ...
 - Pilote : Remplie un tableau de suivi des différents postes

Première étape, le du Waterfall : chaque rôle devait finir son travail pour 5 cartes avant de passer au suivant.
...
Deuxième étape, le Scrum : chaque rôle peut faire passer une carte au prochain dès que son travaille sur celle-ci est fini.
...
Dernière étape, le Kanban : comme pour le scrum, une carte peut passer à l'étape d'après, dès qu'elle est terminée.
...
Au final, nous avons pu terminer 6 cartes (un bug est survenue en cours de route).Le Kanban a permis une avancée plus importante, mais le suivi par le pilote était plus compliqué, car les cartes bougeaient très vite.
