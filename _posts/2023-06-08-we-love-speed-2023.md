...
How do you build a perf community inside your company.

Être isolé à faire de la perf n'est pas souhaitable.

La redoute a embarqué, aussi bien le marketing, le design, la tech.

6 mois pour contruire la commu.

Cela permet d'avoir une stratégie d'entreprise et de mettre en valeur le travail accompli

La mesure de perf permet de montrer

https://youtu.be/aGi-vxC6ttA

Context :
boite internationnale de vente

Pourquoi monter une commu webperf => sans ça marche moins bien
=> il faut des gens de différents horizons pour que les décisions soient partagées, communiquées

- dev
- infra
- seo
- business
- boss => qqun avec un pouvoir décisionnel

Il y a des référents qui font parti d'équipes (réu de 30min)

Comment le faire vivre =>

- réu hebdo
- créer des CR (pour les absents, pour la contrib) => un simple mail => le Cr permet d'expliquer les diffs
- partage techs
- avoir des graph et des métriques => Core web vitals + SEO

Résultats =>

- Il y aura toujours des problèmes mais on peut mieux les traiter
- on identifie les améliorations et on priorise
- on traite les pbms + rapidement
- toujours qq chose a faire en webperf => préparer l'arrivée du INP
- rester au niveau
