...
You have many strategies to prioritize your perfomances subjects. Philip Tellis talked about performance with a psycholgical aspect around cognitive bias.

> If you have a brain you have a bias

With the three following example, you'll see how bias can impact your job and how you can use them at your advantage.

- The **negativity bias** means that you'll remember more a bad experience than a good experience even if they have the same intensity. That's why you're slowest page shouldn't be more that 15 times slower than you're fatest page, because users will think it's the norm on your app. There is a way to reduce this bias by being honest with your user. You can display a message indicating that you detect that this page is slow and something is happening in the background to resolve the issue. It's important to do that because, fun fact (or not), slow pages are associated to a 38% increase of cardiac rythm, which is the same level as an horror movie. Preserve your users from stress and anxity, invest on perf and be transparent with them.

- The **serial position effect** means that we remember more the beginning and the end of an experience. This one is very interesting for us. We're developing application in Smart TV where performance issues are challenging on two topics : page load and navigation through remote controle. This bias taught us that in order to increase end user satisfaction we should invest more time on page load that on remote control navigation. Another statistic that confirm this is that an increase delay of 500ms leads to a 26% increase of frustration and.

- The **escalation of commitment** is the tendency to continue an endeavor once an investments of money, effort or time have been made. This taught us that the first pages users see should be fast in order to increase the retention level. This is directly correlated

We took three example, Philip gives some more and it exists even more than the one he presented. It was a very interesting talk and way of seeing performances based on our cognitive bias. Thanks Philip.

We all have bias, and our objective as developers is to accept them, and use them to plan the future updates of our apps.

https://youtu.be/6KwW5v5rce4

### Community

It's nice to know which part of your app you need to optimize, but don't forget that you're working in a company, with humans. They don't have the same job, thoughts, preocupations as you. That's why it's important to spread the performances issues accross all departments of your company.

This is a subject that has been adressed in La Redoute which create a performance community inside their company.

In order to give you some context, La Redoute is an international clothes seller. They need to deal with performances issues for sure but also with synchronization and contributions problematics on their platform.

That why they built this community which includes people from different departments : technical, marketing, finacial, design, products, seo...

It's not desirable to be the only departement of a company to be concerned by performances because each one of them can bring some material in order to help, which in definitive helps the company.

This community meets once a week, during 30 minutes, in order to spread knowledge and share news about perfromances topics. They also write a report at the end of the meeting in order to let people who missed the meeting be up to date and also for people that are working on different time zone. They're an international company, they dealt with that.

It took them 6 months in order to see the first benefits and after 1 year they considered the community mature. They'll continue their meeting because the goal isn't to prevent all issues. But it's here to reduce the impact and react faster to them.

Thanks to them, it's very inspiring.
