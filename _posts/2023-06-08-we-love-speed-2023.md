...
- Does users have a stable visual response? ➡️ it's mesured though the _Cumulative Layout Shift_ (CLS)
- Do users quickly see content they can trust? ➡️ it's mesured though the _Largest Contentful Paint_ (LCP)
- Can users quickly interact with the page in a qualitative way? ➡️ it's mesured though the _First Input Delay_ (FID)
