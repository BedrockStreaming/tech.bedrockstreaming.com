...
We all have bias, and our objective as developers is to take them in account to plan the future updates of our apps.

TVJS => 2 problématiques de perf (navigation et lancement)
En prenant en compte le fait qu'un utilisateur se souvient de la 1ere expérience, les temps de lancement de l'app est plus important que la navigation catalogue.

Est ce que les potentiels clients ont la même approche, la question reste ouverte ?

https://youtu.be/6KwW5v5rce4

500ms délais supplémùentaire conduit à une augmentation de 26% de la frustration & 8% de désengagement.

Serial position effect => on se souvient du début et de la fin
En d'autre termes la rétention est une fonction de la 1ere et dernière page. Et ou la dernière page a plus de poids.

Nagativity bias, une mauvaise XP d'intensité' équivalente a une bonne XP sera plus mémorable.

⚠️ Attention aux correlation trompeuses, une page plus lente est associée a une meilleur taux de converstion, cela est du au fait que les pages d'erreurs sont très rapide

38% d'accéleration du rythme cardiaques causé par des page lente => niveau d'anxiété d'un film d'horreur.

Il est important de concentrer ses efforts sur qq pages clés :

- La permière page affecte le taux de rebond
- La perf de la page la plus rapide et de la dernière page affectent la rétention
- La page la plus lente ne doit pas être plus de 15x plus lente que la page la plus rapide
- Informer l'utilisateur que l'on a conscience que son expeirence est dégradé diminue la perception negative
- Une page rapide améliore le nombre de page / session => le nombre de page par session étant determinant dans le taux de conversion, cette métrique est capitale
- Les utilisateurs sont plus patients lorsqu'ils utilisent le web au bureau et moins lorsqu'ils l'utilisent sur leur telephones
