...
cas critiques auxquels on n'aurait jamais pensé.
...
[SplPriorityQueue](https://www.php.net/manual/fr/class.splpriorityqueue.php) seront
abordées, mais on constatera rapidement qu'elles présentent l'inconvénient majeur
...
Florian nous présentera notamment [DS\PriorityQueue](https://www.php.net/manual/en/class.ds-priorityqueue.php)
et [DS\Vector](https://www.php.net/manual/en/class.ds-vector), qui constitue une
alternative intéressante à `array`.

#### Les iterators

Enfin, nous verrons les iterators de la SPl avec :
...
Dans l’entreprise de Smaine, Yousign, ils ont une organisation sous forme de squads.
