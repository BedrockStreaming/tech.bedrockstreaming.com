...
description: >-
  Présentation de la librairie superagent-mock, un plugin superagent open-source
  à utiliser pour mocker le retour de vos requêtes HTTP.
tags:
  - javascript
  - superagent
  - mock
...
author: team_cytron
date: '2015-03-30'
permalinkOverride: comment-a-t-on-bouchonne-les-developpeurs-backend
---
