---
title: "Announcing BedrockStreaming/pr-size-labeler github action \U0001F389"
description: >-
  We have just published a github action that dynamically adds size labels to
  _Pull Requests_ based on the size of the diff and the number of modified
  files.
lang: en
tags:
  - oss
