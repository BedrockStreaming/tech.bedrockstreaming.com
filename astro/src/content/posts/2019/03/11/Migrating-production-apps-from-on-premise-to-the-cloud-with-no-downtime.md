...
feature-img: "./kaushik-panchal-37070-unsplash.jpg"
comments: true
language: en
---
...
![Application before the migration to AWS & Kubernetes](./application_pre_migration.png)
...
![Application while migrating 1% to AWS & Kubernetes](./application_migrating.png)
...
![Average connect times from HAProxy to backends](./haproxy_cloud_connect_time_avg.png)
...
![Average response times from HAProxy to backends](./haproxy_cloud_response_time_avg.png)
...
![HTTP codes 2xx](./haproxy_cloud_http2xx_codes.png)
...
![HTTP codes 2xx with 100% traffic sent to AWS](./haproxy_cloud_http2xx_codes_100pc.png)
...
![Application while migrating 50% to AWS & Kubernetes for specific v2 path](./application_migrating_specific_v2_path.png)
...
![Replicating production traffic with gor](./gor-traffic-replication.png)
