...
![Error Port Allocation Graph](./error-port-allocation.png)
...
![Outgoing Traffic without Egress Controller](./outgoing-traffic-without-egress-schema.png)
...
![Outgoing Traffic with Egress Controller](./outgoing-traffic-with-egress-schema.png)
...
![CPU consumption of an app configured to use Egress Controller for DynamoDB requests](./cpu-metrics.png)
...
![Detailed Configuration Schema](./detailed-configuration.png)
