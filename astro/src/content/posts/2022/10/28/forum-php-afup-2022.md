...
![Le stand Bedrock](./stand-bedrock.jpg)
...
![Nos 2 Backend managers, Mikael et FX en train d’animer l’épreuve des casse-têtes](./backend-managers.jpg)
...
![Schéma OpenTelemetry](./open-telemetry.png)
...
![Schéma mathématique](./schema-maths.png)
...
![schéma de validation](./presentation-validation-openapi.png)
...
![Anne-Laure durant sa présentation](./presentation-anne-laure.jpg)
...
![La fresque Lego communautaire](./fresque-lego-communautaire.jpg)
