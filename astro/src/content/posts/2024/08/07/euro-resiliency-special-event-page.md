...
![Photo of the old Special Event page, in 2021](./Old_SEP.png)
...
![Request/Response graph showing the CDN send a Special Event page to a request without cookie, and the usual page if the cookie is present](./Request_Response_graph.png)
...
![Photo of the new Special Event page, in 2024](./New_SEP.png)
...
![Graph displaying the proportion of Special Event page distributed, with around 70% of pages being the Special Event Page once enabled](./SEP_graph_effic.png)
![Graph displaying the amount of specific pages response, decreasing by almost 2 times when the Special Event page was displayed](./SEP_response_decrease.png)
