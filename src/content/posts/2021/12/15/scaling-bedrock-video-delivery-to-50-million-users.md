...
comments: false
thumbnail: "./Visuel-BR-Devices-HD-6V2-BRLogo.jpg"
language: en
redirect_from:
...
![Pictorial explanation of video streaming](pictorial-explanation-of-video-streaming.png)
...
![Comparing Just-In-Time Packaging with Offline Packaging](jit-versus-offline-packaging.png)
...
![v1 of our VOD platform](vod-usp-v1.png)
...
![Details on the composition of a USP origin](usp-origin-instance-detailed.png)
...
![Inefficiency of a Round Robin algorithm in front of cache servers](../../../../../assets/images/image5.png)
...
![Consistent Hashing is an ideal method for caches](../../image10.png)
...
![v2 of our VOD platform](vod-usp-v2.png)
...
![Nginx cache hit ratio](nginx-cache-hit-ratio.png)
...
![AWS Cost Explorer, October 2020](aws-cost-explorer-oct-2020.png)
...
![The costs of this platform, where v3 was deployed in mid-November 2020](aws-cost-explorer-oct-to-dec-2020.png)
...
![v3 of our VOD platform](vod-usp-v3.png)
...
![A server whose bandwidth is throttled (seen from CloudWatch)](a-server-whose-bandwidth-is-throttled.png)
...
![Graph showing few overloaded servers, using classic Consistent Hashing](consistent-hashing-inegality-legends.png)
...
![Graph showing the effects of Bounded Loads over Consistent Hashing](testing-consistent-hashing-with-bounded-loads.png)
